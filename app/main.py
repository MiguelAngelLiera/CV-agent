...
def _generate_with_fallback(gemini_contents: list, trace_id: str):
    """
    Intenta GEMINI_MODEL con reintentos y backoff corto.
    Si se agotan los intentos, hace un único intento con GEMINI_FALLBACK_MODEL
    antes de rendirse

    Args:
        gemini_contents (list): contenido pasado a generate_content
        trace_id (str): trace id para el logger.

    Raises:
        last_error: se agotaron todos los modelos y reintentos
    """
